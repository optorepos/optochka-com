        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              with Our Epic Store Solution
            </p>
            <div className="mt-10 flex flex-col gap-y-2 md:flex-row items-center justify-center gap-x-6">
              <button
                className="py-4 px-6 w-full text-white font-semibold border border-black rounded-xl focus:ring focus:ring-blue-300 bg-black hover:bg-blue-700 transition ease-in-out duration-200"
                type="button"
              >
